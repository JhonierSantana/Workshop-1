...
const comparaciones = async () => {
  ...
  console.log(
    `El sueldo es inferior a $2000 US y su antiguedad es igual o superior a 10 años? ${comparacion1}`
  );

  let comparacion2 = sueldo < 2000 || antiguedad < 10;
  console.log(
    `El sueldo es inferior a $2000 US o su antiguedad es menor a 10 años? ${comparacion2}`
  );
